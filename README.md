# haskell-course
A simplified version of IOGs Haskell course for experienced imperative programmers.

This version of the Haskell course tries to find the right balance in explaining a
new concept of programming to experienced imperative programmers.

It generally spents less time when explain programming basics as e.g. recursion,
explaining Haskell concepts as purity or fetaures as input-output computation. 
...
taught in lesson 1 how to compile and interact with haskell code in the GHCi repl.
...
which will also be explained in lesson 1. 

The homework instructions can be found in the *homework/* folder and are written
in pure haskell files. Solutions to homework can be found on the **solutions** 
branch and are also written as pure haskell files. 
